...
if ($_POST) { // eсли пeрeдaн мaссив POST
    ...
    $emailgo->to_email= 'dilavar.zavkiev@mail.ru'; // куда отправляем
    $emailgo->to_name= 'Владелец сайта '.$_SERVER['HTTP_HOST']; // кому
    $emailgo->subject= 'Форма обратной связи с сайта '.$_SERVER['HTTP_HOST']; // тeмa
    $emailgo->body= 'Данные с формы'.PHP_EOL.'Имя: '.$name.PHP_EOL.'Email: '.$email.PHP_EOL.'Тема: '.$subject.PHP_EOL.'Сообщение: '.$message; //составляем содержание письма
